        ...
        <span class="icon-bg"><i class="fas fa-signature" style="color: #fc8a29;"></i></span>
        <span class="menu-title">Nom</span>
        <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="aut">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href=" {% url 'blank_page' %} "> Tesla </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'login' %} "> Lamborghini </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'register' %} "> Range rover </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'error_404s' %} "> Ferrari </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'error_500s' %} "> Bus </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'error_500s' %} "> Camions </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'error_500s' %} "> Taxi </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'error_500s' %} "> Corbillards </a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'error_500s' %} "> Autres </a></li>
        </ul>
        </div>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#mdi" aria-expanded="false" aria-controls="mdi">
        <span class="icon-bg"><i class="fas fa-hockey-puck" style="color: #fc8a29;"></i></span>
        <span class="menu-title">Categorie</span>
        <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="mdi">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href=" {% url 'buttons' %}">Petit</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'dropdowns' %} ">Grand</a></li>
        </ul>
        </div>
        </li>
        ...
        <span class="icon-bg"><i class="fas fa-users" style="color: #fc8a29;"></i></span>
        <span class="menu-title">Capacité</span>
        <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href=" {% url 'buttons' %}">2 Personnes (10)</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'dropdowns' %} "> 4 Personnes (10)</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'typography' %}"> 8 Personnes (10)</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'typography' %}" type="checkbox"> Plusieurs</a></li>
        </ul>
        </div>
        </li>
        ...
        <div class="collapse" id="mdi">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href=" {% url 'buttons' %}">Manuel</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'dropdowns' %} ">Automatique</a></li>
        </ul>
        </div>
        </li>
        ...
        <span class="icon-bg"><i class="fas fa-charging-station" style="color: #fc8a29;"></i></span>
        <span class="menu-title">Caburant</span>
        <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="basic">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href=" {% url 'buttons' %}">Min. 50L</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'dropdowns' %} ">Max. 50L Min. 100L</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'typography' %}">Max. 100L</a></li>
        </ul>
        </div>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#ibasic" aria-expanded="false" aria-controls="ibasic">
        <span class="icon-bg"><i class="fas fa-hand-holding-usd" style="color: #fc8a29;"></i></span>
        <span class="menu-title">Prix</span>
        <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="ibasic">
        <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href=" {% url 'buttons' %}">Min. 50.00$</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'dropdowns' %} ">Max. 50.00$ Min. 100.00$</a></li>
        <li class="nav-item"> <a class="nav-link" href=" {% url 'typography' %}">Max. 100.00$</a></li>
        </ul>
        </div>
        </li>
