...
<li class="nav-item" style="border-radius:7px;" >
    ...
    <div class="main-panel">
        ...
        <div class="col-md-4 grid-margin bg-white" style=" border-radius:6px;margin-top:120px;" >
            <!-- <div class="col-4" style="margin:100px;padding-right:30px;background-color:#ffffff;position:relative; right:80px;padding-bottom:50px;"> -->
            <p><strong>Details sur la Location</strong></p>
                <!--Google map-->
                <div id="map-container-google-1" class="z-depth-1-half map-container" style="height:300px; border-radius:18px;width:400px;margin:-6px" >
                    <iframe src="https://maps.google.com/maps?q=manhatan&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
                        style="border:0" allowfullscreen></iframe>
               </div>
            <!--Google Maps-->
                 <div class="col-10" style="margin: 30px; border-radius:20px; padding-bottom:10px"  >
                                   
                                    <div class="row" style="padding-top:10px;">
                                        <div style="display: flex;">
                                            <div style="background-color: #fc8a29; border-radius:6px;">
                                            <img style="width:180px;height:100px" src="{{asset('font/images/Range Rover Evoque Orange Car - 1371x817.png')}}"alt="Tigre">
                                            </div>
                                            <div style="padding: 20px;">
                                            <span style="color:black"><strong>Pacitte</strong>
                                            </div>
                                        </div>
                                    ...
                                    <div style="display: flex;position: relative;bottom:10px;justify-content:space-between;">
                                ...
                                <div class="row row-10" >
                                    <!-- <div style="display: flex; margin-bottom:30px;position: relative;bottom:15px;justify-content:space-between" class="col-lg-10"> -->
                                         <div class="col " style="position:relative;left:30px;">
                                            <div>
                                            <input type="radio" style="margin-left: -65px;"> <strong>Reception</strong>
                                            <section style="margin-left: -65px;">
                                                <label style="font-size: small;"><strong>Date & Time</strong></label>
                                                <p style="margin-top:-8px;color:#a494a9;">20/22/55</p>
                                            </section>
                                            </div>
                                            <div>
                                            <input type="radio" style="margin-left: -65px;"> <strong>Depot</strong>
                                            <section style="margin-left: -65px;">
                                                <label style="font-size: small;"><strong>Date & Time</strong></label>
                                                <p style="margin-top:-8px;color:#a494a9;">20/22/55</p>
                                            </section>
                                        ...
                                        <div class="col " style="position:relative;left:110px;">
                                            ...
                                            <input type="radio" style="margin-left: -65px;"> <strong>Propriétaire</strong>
                                            <section style="margin-left: -65px;">
                                                <label style="font-size: small;"><strong>Nom</strong></label>
                                                <p style="margin-top:-8px;color:#a494a9;">Serge ELECHO</p>
                                            </section>
                                            <section style="margin-left: -65px;">
                                                <label style="font-size: small;"><strong>Numero</strong></label>
                                                <p style="margin-top:-8px;color:#a494a9;">98964647</p>
                                            </section>

                                            <section style="margin-left: -65px;">
                                                <label style="font-size: small;"><strong>Adresse</strong></label>
                                                <p style="margin-top:-8px;color:#a494a9;">elechoserge@gmail.com</p>
                                            </section>

                                            <section style="margin-left: -65px;">
                                                <label style="font-size: small;"><strong>Ville/Village</strong></label>
                                                <p style="margin-top:-8px;color:#a494a9;">Calavi</p>
                                            </section>
             ...
             <div class="col-md-6 grid-margin bg-white" style=" border-radius:6px;margin-top:120px;margin-right:30px;">
            <!-- <div class="col-4" style="margin:100px;padding-right:30px;background-color:#ffffff;position:relative; right:80px;padding-bottom:50px;"> -->
            <p><strong>Details sur la Location</strong></p>
                <!--Google map-->
                <div id="map-container-google-1" class="z-depth-1-half map-container" style="height:300px; border-radius:18px;width:400px;margin:-6px" >
            ...
            <!--Google Maps-->
                 <div class="col-10" style="margin: 30px; border-radius:20px; padding-bottom:10px"  >
                    ...
                    <p>Overall price and includes rental discoun</p>
                 </div>
